...
#hero .floating-icons i:first-child {
  color: #e34f26;
  animation-delay: 0s;
  top: 20%;
  left: 10%;
...
#hero .floating-icons i:nth-child(2) {
  color: #1572b6;
  animation: 6s ease-in-out 1s infinite float2;
}

#hero .floating-icons i:nth-child(3) {
  color: #f7df1e;
  animation: 6s ease-in-out 2s infinite float3;
}

#hero .floating-icons i:nth-child(4) {
  color: #61dafb;
  animation: 6s ease-in-out 3s infinite float4;
}

#hero .floating-icons i:nth-child(5) {
  color: #333;
  animation: 6s ease-in-out 4s infinite float5;
}
...
#skills .project-wrapper__text {
  text-align: center;
}

#skills .project-wrapper__text-title {
  margin-bottom: 1rem;
  font-size: 2.5rem;
  font-weight: bold;
}
...
#skills .project-wrapper__image {
  width: 100%;
}

#skills .project-wrapper__image .thumbnail {
  border: none;
  transition: transform .3s, box-shadow .3s;
  box-shadow: 0 4px 8px #0000001a;
}

#skills .project-wrapper__image .thumbnail:hover {
